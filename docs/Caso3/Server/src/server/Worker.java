...
public class Worker implements Runnable
{
	...
	public void run( )
	{
		...
		catch( NullPointerException | InvalidKeyException | NoSuchPaddingException | IllegalStateException | NoSuchAlgorithmException | IOException | FontFormatException e )
		{
